...
/* aqui en la gramatica de fitxi hay un punto despues de falgoritmo que hemos quitado porque en los ejemplos no esta*/
    TK_PR_ALGORITMO TK_IDENTIFICADOR TK_PUNTOYCOMA ty_cabecera_alg ty_bloque_alg TK_PR_FALGORITMO {printf("REDUCE ty_desc_algoritmo: TK_PR_ALGORITMO TK_IDENTIFICADOR TK_PUNTOYCOMA ty_cabecera_alg ty_bloque_alg TK_PR_FALGORITMO\n");}
    ;
...
ty_bloque_alg:
    ty_bloque TK_COMENTARIO {printf("REDUCE ty_bloque_alg: ty_bloque TK_COMENTARIO\n");}
    ;

ty_decl_globales:
      ty_decl_tipo  ty_decl_globales {printf("REDUCE ty_decl_globales: ty_decl_tipo  ty_decl_globales\n");}
    | ty_decl_cte ty_decl_globales {printf("REDUCE ty_decl_globales: ty_decl_cte ty_decl_globales\n");}
    | /*vacio*/{printf("REDUCE ty_decl_globales: vacio\n");}
    ;

ty_decl_a_f:
      ty_accion_d  ty_decl_a_f {printf("REDUCE ty_decl_a_f: ty_accion_d  ty_decl_a_f\n");}
    | ty_funcion_d ty_decl_a_f {printf("REDUCE ty_decl_a_f: ty_funcion_d ty_decl_a_f \n");}
    | /*vacio*/ {printf("REDUCE ty_decl_a_f: vacio\n");}
    ;

ty_bloque:
    ty_declaraciones ty_instrucciones {printf("REDUCE ty_bloque: ty_declaraciones ty_instrucciones\n");}
    ;

ty_declaraciones:
      ty_decl_tipo ty_declaraciones {printf("REDUCE ty_declaraciones: ty_decl_tipo  ty_declaraciones\n");}
    | ty_decl_cte  ty_declaraciones {printf("REDUCE ty_declaraciones: ty_decl_cte ty_declaraciones \n");}
    | ty_decl_var  ty_declaraciones {printf("REDUCE ty_declaraciones: ty_decl_var   ty_declaraciones\n");}
    | /*vacio*/{printf("REDUCE ty_declaraciones: vacio\n");}
    ;

ty_decl_tipo:
    TK_PR_TIPO ty_lista_d_tipo TK_PR_FTIPO TK_PUNTOYCOMA {printf("REDUCE ty_decl_tipo: TK_PR_TIPO ty_lista_d_tipo TK_PR_FTIPO TK_PUNTOYCOMA\n");}
    ;

ty_decl_cte:
    TK_PR_CONST ty_lista_d_cte TK_PR_FCONST TK_PUNTOYCOMA {printf("REDUCE ty_decl_cte: TK_PR_CONST ty_lista_d_cte TK_PR_FCONST TK_PUNTOYCOMA\n");}
    ;

ty_decl_var:
    TK_PR_VAR ty_lista_d_var TK_PR_FVAR TK_PUNTOYCOMA {printf("REDUCE ty_decl_var: TK_PR_VAR ty_lista_d_var TK_PR_FVAR TK_PUNTOYCOMA\n");}//los programas de fitxi no tienen ;
    ;

ty_lista_d_tipo:
      TK_IDENTIFICADOR TK_IGUAL ty_d_tipo TK_PUNTOYCOMA ty_lista_d_tipo {printf("REDUCE ty_lista_d_tipo: TK_IDENTIFICADOR TK_IGUAL ty_d_tipo TK_PUNTOYCOMA ty_lista_d_tipo\n");}
    | /*vacio*/{printf("REDUCE ty_lista_d_tipo: vacio\n");}
    ;

ty_d_tipo:
      TK_PR_TUPLA ty_lista_campos TK_PR_FTUPLA {printf("REDUCE ty_d_tipo: TK_PR_TUPLA ty_lista_campos TK_PR_FTUPLA\n");}
    | TK_PR_TABLA TK_INICIO_ARRAY ty_expresion_t TK_SUBRANGO ty_expresion_t TK_FIN_ARRAY TK_PR_DE ty_d_tipo {printf("REDUCE ty_d_tipo: TK_PR_TABLA TK_INICIO_ARRAY ty_expresion_t TK_SUBRANGO ty_expresion_t TK_FIN_ARRAY TK_PR_DE ty_d_tipo\n");}
    | TK_IDENTIFICADOR {printf("REDUCE ty_d_tipo: TK_IDENTIFICADOR\n");}
    | ty_expresion_t TK_SUBRANGO ty_expresion_t {printf("REDUCE ty_d_tipo: ty_expresion_t TK_SUBRANGO ty_expresion_t\n");}
    | TK_PR_REF ty_d_tipo {printf("REDUCE ty_d_tipo: TK_PR_REF ty_d_tipo\n");}
    | ty_tipo_base {printf("REDUCE ty_d_tipo: ty_tipo_base\n");}
    ;

ty_expresion_t:
      ty_expresion {printf("REDUCE ty_expresion_t: ty_expresion\n");}
    | TK_CARACTER{printf("REDUCE ty_expresion_t: TK_CARACTER\n");}
    /*AQUI NO HAY CADENAS?????? ENTONCES NO SE PUEDE HACER a:= "hola"   */
    ;

ty_lista_campos:
    TK_IDENTIFICADOR TK_TIPO_VAR ty_d_tipo TK_PUNTOYCOMA ty_lista_campos {printf("REDUCE ty_lista_campos: TK_IDENTIFICADOR TK_TIPO_VAR ty_d_tipo TK_PUNTOYCOMA ty_lista_campos\n");}
    |/*vacio*/{{printf("REDUCE ty_lista_campos: vacio\n");}}
    ;

ty_tipo_base:
    /*BOOLEANO NO ESTABA ORIGINALMENTE EN LA DOCUMENTACION*/
     TK_PR_BOOLEANO {printf("REDUCE ty_tipo_base: TK_PR_BOOLEANO\n");}
    |TK_PR_ENTERO {printf("REDUCE ty_tipo_base: TK_PR_ENTERO\n");}
    |TK_PR_CARACTER {printf("REDUCE ty_tipo_base: TK_PR_CARACTER\n");}
    |TK_PR_REAL {printf("REDUCE ty_tipo_base: TK_PR_REAL\n");}
    |TK_PR_CADENA {printf("REDUCE ty_tipo_base: TK_PR_CADENA\n");}
    ;

ty_lista_d_cte:/*En el enunciado pone "literal" pero se referira a ty_tipo_base*/
    TK_IDENTIFICADOR TK_IGUAL ty_tipo_base TK_PUNTOYCOMA ty_lista_d_cte{printf("REDUCE ty_lista_d_cte: TK_IDENTIFICADOR TK_IGUAL ty_tipo_base TK_PUNTOYCOMA ty_lista_d_cte\n");}
    |/*vacio*/{printf("REDUCE ty_lista_d_cte: vacio\n");}
    ;

ty_lista_d_var:
      ty_lista_id TK_TIPO_VAR ty_d_tipo TK_PUNTOYCOMA ty_lista_d_var {printf("REDUCE ty_lista_d_var: ty_lista_id TK_TIPO_VAR ty_d_tipo TK_PUNTOYCOMA ty_lista_d_var\n");}
    | /*vacio*/{printf("REDUCE ty_lista_d_var: vacio\n");}
    ;

ty_lista_id:
      TK_IDENTIFICADOR TK_SEPARADOR ty_lista_id {printf("REDUCE ty_lista_id: TK_IDENTIFICADOR TK_SEPARADOR ty_lista_id\n");}
    | TK_IDENTIFICADOR {printf("REDUCE ty_lista_id: TK_IDENTIFICADOR\n");}
    ;

ty_decl_ent_sal:
      ty_decl_ent {printf("REDUCE ty_decl_ent_sal: ty_decl_ent\n");}
    | ty_decl_ent ty_decl_sal {printf("REDUCE ty_decl_ent_sal: ty_decl_ent ty_decl_sal\n");}
    | ty_decl_sal {printf("REDUCE ty_decl_ent_sal: ty_decl_sal\n");}
    ;

ty_decl_ent:
    TK_PR_ENT ty_lista_d_var {printf("REDUCE ty_decl_ent: TK_PR_ENT ty_lista_d_var\n");}
    ;

ty_decl_sal:
    TK_PR_SAL ty_lista_d_var {printf("REDUCE ty_decl_sal: TK_PR_SAL ty_lista_d_var\n");}
    ;

ty_expresion:
      ty_exp_a {printf("REDUCE ty_expresion: ty_exp_a\n");}
    | ty_exp_b %prec TK_NADA_PRIORITARIO{printf("REDUCE ty_expresion: ty_exp_b\n");} /*ESTO NO TIENE QUE FUNCIONAR ASI!!!!!*/
    | ty_funcion_ll {printf("REDUCE ty_expresion: ty_funcion_ll\n");}
    ;

ty_exp_a:
      ty_exp_a TK_MAS ty_exp_a {printf("REDUCE ty_exp_a: ty_exp_a TK_MAS ty_exp_a\n");}
    | ty_exp_a TK_MENOS ty_exp_a {printf("REDUCE ty_exp_a: ty_exp_a TK_MENOS ty_exp_a\n");}
    | ty_exp_a TK_MULT ty_exp_a {printf("REDUCE ty_exp_a: ty_exp_a TK_MULT ty_exp_a\n");}
    | ty_exp_a TK_DIV ty_exp_a {printf("REDUCE ty_exp_a:  ty_exp_a TK_DIV ty_exp_a \n");}
    | ty_exp_a TK_MOD ty_exp_a {printf("REDUCE ty_exp_a: ty_exp_a TK_MOD ty_exp_a\n");}
    | ty_exp_a TK_DIV_ENT ty_exp_a {printf("REDUCE ty_exp_a: ty_exp_a TK_DIV_ENT ty_exp_a\n");}
    | TK_PARENTESIS_INICIAL ty_exp_a TK_PARENTESIS_FINAL {printf("REDUCE ty_exp_a: TK_PARENTESIS_INICIAL ty_exp_a TK_PARENTESIS_FINAL\n");}
    | ty_operando {printf("REDUCE ty_exp_a: ty_operando\n");}
    | TK_ENTERO {printf("REDUCE ty_exp_a: TK_ENTERO\n");}
    | TK_REAL {printf("REDUCE ty_exp_a: TK_REAL\n");}
    | TK_MENOS ty_exp_a %prec TK_MENOS_U {printf("REDUCE ty_exp_a: TK_MENOS ty_exp_a\n");}
    ;

ty_exp_b:
      ty_exp_b TK_PR_Y ty_exp_b {printf("REDUCE ty_exp_b: ty_exp_b TK_PR_Y ty_exp_b\n");}/*AQUI IGUAL SE PUEDEN DEFINIR OP_LOGICO: CUYOS VALORES SEAN Y,O*/
    | ty_exp_b TK_PR_O ty_exp_b {printf("REDUCE ty_exp_b: ty_exp_b TK_PR_O ty_exp_b\n");}
    | TK_PR_NO ty_exp_b %prec TK_MUY_PRIORITARIO{printf("REDUCE ty_exp_b: TK_PR_NO ty_exp_b\n");}
    | TK_BOOLEANO {printf("REDUCE ty_exp_b: TK_BOOLEANO\n");}
    | ty_expresion TK_OP_RELACIONAL ty_expresion {printf("REDUCE ty_exp_b: ty_expresion TK_OP_RELACIONAL ty_expresion\n");}
    | TK_PARENTESIS_INICIAL ty_exp_b TK_PARENTESIS_FINAL {printf("REDUCE ty_exp_b: TK_PARENTESIS_INICIAL ty_exp_b TK_PARENTESIS_FINAL\n");}
    ;
